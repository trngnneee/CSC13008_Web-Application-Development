...
export const CSVUploader = ({ 
  ...
  const [
    ...
    accept: ".csv, application/vnd.ms-excel, text/csv, application/csv, text/plain",
    maxSize,
    multiple: true,
    maxFiles,
  })
      ...
      >
        ...
        {files.length > 0 ? (
          <div className="flex w-full flex-col gap-3">
            <div className="flex items-center justify-between gap-2">
              <h3 className="truncate text-sm font-medium">
                File CSV đã upload ({files.length})
              </h3>
              <Button
                type="button"
                variant="outline"
          ...
          <div className="flex flex-col items-center justify-center px-4 py-3 text-center">
            ...
            <p className="mb-1.5 text-sm font-medium">Kéo file CSV vào khu vực này để tải lên</p>
