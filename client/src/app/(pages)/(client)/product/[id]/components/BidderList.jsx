...
import { getBidderListByProduct, kickBidderFromProduct } from "@/lib/clientAPI/bid";
import { useParams } from "next/navigation";
import { dateTimeFormat } from "@/utils/date";
import { Ban, CircleAlertIcon } from "lucide-react";
...
export const BidderList = () => {
  ...
  const handleKickBidder = (id_bidder) => () => {
    ...
    setBidderList((prev) => prev.filter((bidder) => bidder.id_user !== id_bidder));
  }
